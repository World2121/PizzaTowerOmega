...
idlespr = spr_spearer_walk
stunfallspr = spr_spearer_stunned
walkspr = spr_spearer_walk
grabbedspr = spr_spearer_stunned
scaredspr = spr_spearer_scared
turnspr = spr_spearer_turning
image_xscale = -1
flash = false
slapped = false
birdcreated = false
boundbox = false
spr_dead = spr_spearer_dead
important = false
heavy = false
depth = 0
